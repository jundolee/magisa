...
export const SITE_TITLE = "매일 읽는 테크 기사 | 최신 테크 기사 모아보기";
export const SITE_DESCRIPTION =
  "개발·AI·데이터·제품 분야의 최신 테크 기사를 매일 모아서 보여드립니다. 여러 블로그에 흩어진 테크 기사를 한곳에서 읽고, 읽음/즐겨찾기로 관리하세요.";
...
export const SITEMAP_LAST_MODIFIED = "2026-09-22T00:00:00.000Z";
